...
> 1984 年的《King's Quest》是圖形冒險遊戲的起點。在它之前，冒險遊戲是一片黑底綠字，
> 你讀敘述、打指令，畫面裡什麼都沒有。KQ1 讓玩家第一次看著自己的角色走進一座有前後景、
> 會遮擋、能繞到柱子後面的立體場景——那年很多人第一次意識到，電腦遊戲原來可以「看得到」。

台灣玩家對這款遊戲的記憶，多半不是來自 Sierra，而是來自**第三波資訊文化事業**那個編號
**PC22** 的盒裝：一片 2D 磁片、一本薄薄的中文說明書，封面畫著騎士站在噴火的巨龍口中，
右上角印著「NT 99 元」。說明書封面上的標題是**《國王密令》**。

這個專案把它的兩個 DOS 版本都做成繁體中文：**1984/1987 的 AGI 原版**，以及 **1990 年
Sierra 用 SCI 引擎重製的版本**。譯名一律照那本第三波說明書——所以這裡的主角是**格拉漢爵士**，
